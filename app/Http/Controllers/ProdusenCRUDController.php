...
class ProdusenCRUDController extends Controller
{
/**
...
{
$data['produsens'] = Company::orderBy('id','desc')->paginate(5);
return view('produsens.index', $data);
}
/**
